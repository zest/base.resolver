...
var resolverFactory = function (configPathOrArray, basePath) {
    ...
    resolver = {
         ...
         * interrupted.
         * @returns {external:q} a Promise that gets resolved with {@link module:base-resolver~Resolver} when the reload is
 ...
 * @returns {external:q}  a Promise that gets resolved with {@link module:base-resolver~Resolver} when the resolver is set up.
