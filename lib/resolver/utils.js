...
exports.resolveExpression = function (expression, resolverFunction) {
    ...
    getNextPromise = function () {
        ...
        /*jslint regexp: false */
        return q.fcall(resolverFunction, thisExpression, thisParams, thisExpressionWithParams).then(
            function (value) {
        ...
        function (value) {
            ...
            if (!value && !optional) {
                return deferred.reject(
                    new Error('expression could not be resolved to a defined value. Use ? if this is acceptable (in ' +
                              expression + ')')
                );
            }
